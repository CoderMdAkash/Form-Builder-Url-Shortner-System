            ...
            <div class="card">
                <div class="card-body p-5">
                  ...
                  <form action="{{route('categories.update',$category->id)}}" method="POST" >
                    ...
                    <div class="form-group mt-2">
                        <label for="organization_id">Crganization</label>
                    ...
                    <div class="form-group mt-2">
                        ...
                        <textarea id="description"  name="description" rows="4" class="form-control" placeholder="Leave a comment..."  >{{ $category->description }}</textarea>
                        @error('description')
                            <p id="filled_error_help" class="mt-2 text-xs text-red-600 dark:text-red-400"> {{$message}}</p>
                        @enderror
                    </div>
